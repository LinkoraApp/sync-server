...
- **Multi-Database Support**: Works with MySQL, PostgreSQL, SQLite, and other SQL databases
...
**Warning**: Use untested databases at your own risk. I recommend sticking to MySQL, PostgreSQL, or SQLite.
...
Auto-generated on first run - the server will prompt you for configuration values:
...
Set these environment variables for containerized or cloud deployments:
...
- **Database Compatibility**: Linkora supports multiple databases through Exposed, but has only been tested with MySQL, SQLite, and PostgreSQL
